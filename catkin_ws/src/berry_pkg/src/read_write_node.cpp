...
#include "berry_pkg/GetPosition.h"
#include "berry_pkg/SetPosition.h"
...
bool getPresentPositionCallback(
  berry_pkg::GetPosition::Request & req,
  berry_pkg::GetPosition::Response & res)
{
  uint8_t dxl_error = 0;
...
void setPositionCallback(const berry_pkg::SetPosition::ConstPtr & msg)
{
  uint8_t dxl_error = 0;
  int dxl_comm_result = COMM_TX_FAIL;
