...
#include "berry_pkg/BulkGetItem.h"
#include "berry_pkg/BulkSetItem.h"
...
bool bulkGetItemCallback(
  berry_pkg::BulkGetItem::Request & req,
  berry_pkg::BulkGetItem::Response & res)
{
  uint8_t dxl_error = 0;
...
void bulkSetItemCallback(const berry_pkg::BulkSetItem::ConstPtr & msg)
{
  uint8_t dxl_error = 0;
  int dxl_comm_result = COMM_TX_FAIL;
  int dxl_addparam_result = false;
