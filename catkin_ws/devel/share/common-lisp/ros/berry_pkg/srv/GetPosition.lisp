...
(cl:defmethod cl:initialize-instance :after ((m <GetPosition-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPosition-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name berry_pkg-srv:<GetPosition-request> is deprecated: use berry_pkg-srv:GetPosition-request instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <GetPosition-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader berry_pkg-srv:id-val is deprecated.  Use berry_pkg-srv:id instead.")
  (id m))
...
(cl:defmethod cl:initialize-instance :after ((m <GetPosition-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GetPosition-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name berry_pkg-srv:<GetPosition-response> is deprecated: use berry_pkg-srv:GetPosition-response instead.")))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <GetPosition-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader berry_pkg-srv:position-val is deprecated.  Use berry_pkg-srv:position instead.")
  (position m))
