...
(cl:defmethod cl:initialize-instance :after ((m <BulkGetItem-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BulkGetItem-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name berry_pkg-srv:<BulkGetItem-request> is deprecated: use berry_pkg-srv:BulkGetItem-request instead.")))
...
(cl:defmethod item1-val ((m <BulkGetItem-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader berry_pkg-srv:item1-val is deprecated.  Use berry_pkg-srv:item1 instead.")
  (item1 m))

(cl:ensure-generic-function 'item2-val :lambda-list '(m))
(cl:defmethod item2-val ((m <BulkGetItem-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader berry_pkg-srv:item2-val is deprecated.  Use berry_pkg-srv:item2 instead.")
  (item2 m))
...
(cl:defmethod cl:initialize-instance :after ((m <BulkGetItem-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BulkGetItem-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name berry_pkg-srv:<BulkGetItem-response> is deprecated: use berry_pkg-srv:BulkGetItem-response instead.")))

(cl:ensure-generic-function 'value1-val :lambda-list '(m))
(cl:defmethod value1-val ((m <BulkGetItem-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader berry_pkg-srv:value1-val is deprecated.  Use berry_pkg-srv:value1 instead.")
  (value1 m))

(cl:ensure-generic-function 'value2-val :lambda-list '(m))
(cl:defmethod value2-val ((m <BulkGetItem-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader berry_pkg-srv:value2-val is deprecated.  Use berry_pkg-srv:value2 instead.")
  (value2 m))
