...
(cl:defmethod cl:initialize-instance :after ((m <SyncSetPosition>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SyncSetPosition)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name berry_pkg-msg:<SyncSetPosition> is deprecated: use berry_pkg-msg:SyncSetPosition instead.")))
