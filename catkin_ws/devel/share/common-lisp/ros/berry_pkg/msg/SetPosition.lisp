...
(cl:defmethod cl:initialize-instance :after ((m <SetPosition>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SetPosition)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name berry_pkg-msg:<SetPosition> is deprecated: use berry_pkg-msg:SetPosition instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <SetPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader berry_pkg-msg:id-val is deprecated.  Use berry_pkg-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'position-val :lambda-list '(m))
(cl:defmethod position-val ((m <SetPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader berry_pkg-msg:position-val is deprecated.  Use berry_pkg-msg:position instead.")
  (position m))
